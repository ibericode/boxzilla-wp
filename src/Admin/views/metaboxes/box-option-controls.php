...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td colspan="3">
			...
			<label><input type="radio" class="boxzilla-auto-show-trigger" name="boxzilla_box[trigger]" value="instant" <?php checked( $opts['trigger'], 'instant' ); ?> /> <?php print __( 'Yes, immediately after loading the page.', 'boxzilla' ); ?><input type="number" style="visibility: hidden;" /></label><br />
