...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td colspan="3">
			...
			<label><input type="radio" class="boxzilla-auto-show-trigger" name="boxzilla_box[trigger]" value="time" <?php checked( $opts['trigger'], 'time' ); ?> /> <?php printf( __( 'Yes, after %s seconds on the page.', 'boxzilla' ), '<input type="number" name="boxzilla_box[trigger_time]" min="0" max="1800" value="' . esc_attr( $opts['trigger_time'] ) . '" />' ); ?></label><br />
