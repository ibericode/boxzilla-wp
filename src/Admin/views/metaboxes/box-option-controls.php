...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td colspan="3">
			...
			<label><input type="radio" class="boxzilla-auto-show-trigger" name="boxzilla_box[trigger]" value="time_on_site" <?php checked( $opts['trigger'], 'time_on_site' ); ?> /> <?php printf( __( 'Yes, after %s seconds on the site.', 'boxzilla' ), '<input type="number" name="boxzilla_box[trigger_time_on_site]" min="0" value="' . esc_attr( $opts['trigger_time_on_site'] ) . '" />' ); ?></label><br />
