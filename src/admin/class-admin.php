...
class Admin
{
    ...
    protected function add_hooks()
    {
        ...
        add_action('trashed_post', [ $this, 'flush_rules' ]);
    ...
    public function lazy_add_hooks()
    {
        ...
        add_filter('manage_edit-boxzilla-box_columns', [ $this, 'post_type_column_titles' ]);
        add_action('manage_boxzilla-box_posts_custom_column', [ $this, 'post_type_column_content' ], 10, 2);
    ...
    public function post_type_column_content($column, $post_id)
    {
        ...
        if (method_exists($this, $method_name)) {
            call_user_func([ $this, $method_name ], $post_id);
        }
    }
    ...
    public function register()
    {
        ...
        register_setting('boxzilla_settings', 'boxzilla_settings', [ $this, 'sanitize_settings' ]);
        ...
        wp_register_style('boxzilla-admin', $this->plugin->url('/assets/css/admin-styles.css'), [], $this->plugin->version());
    }
    ...
    public function add_meta_boxes($post_type)
    {
        ...
        add_meta_box(
            ...
            [ $this, 'metabox_box_appearance_controls' ],
            'boxzilla-box',
            'normal',
            'core'
        );
        ...
        add_meta_box(
            ...
            [ $this, 'metabox_box_option_controls' ],
            'boxzilla-box',
            'normal',
            'core'
        );
        ...
        add_meta_box(
            ...
            [ $this, 'metabox_our_other_plugins' ],
            'boxzilla-box',
            'side'
        );
    }
    ...
    public function sanitize_box_rule($rule)
    {
        ...
        if ($rule['condition'] === 'is_url') {
            $rule['value'] = array_map([ $this, 'sanitize_url' ], $rule['value']);
        }
    ...
    public function sanitize_box_css($css)
    {
        ...
        $color_keys = [ 'color', 'background_color', 'border_color' ];
    ...
    protected function sanitize_box_options($opts)
    {
        ...
        $opts['rules']                          = array_map([ $this, 'sanitize_box_rule' ], $opts['rules']);
